...
export default function Topselling() {
  return (
    <div >
        ...
        <h1 className='text-lg font-semibold text-center mt-8'>Top Selling items</h1> 
        <div className='overflow-x-auto whitespace-nowrap mx-4 gap-4 flex overflow-hidden'>
        {Topitems.map((item => ( 
            <div key={item.id} >
