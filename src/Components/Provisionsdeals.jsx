...
import  ProvisionListing  from "./ProvisionListing";



export default function Provisiondeals() {
  return (
    <div >
        
        <h1 className='text-lg font-semibold text-center py-1 mt-4 text-gray-800'>Groceries Deals</h1> 
        <div className='overflow-x-auto whitespace-nowrap mx-4 flex'>
        {ProvisionListing.map((item => ( 
            <div key={item.id} className='scale-90'>
               <div   className='bg-slate-100 rounded-md w-36 p-2 flex flex-col items-center justify-center shadow-lg relative hover:scale-105 '>
